...
export function sendFile(fileName, range, response) {
...
export function sendCompleteFile(fileName, response) {
	var responseHeaders = {
...
export function sendPartialFile(fileName, range, response) {
...
export function sendResponse(response, status, responseHeaders, readable) {
...
export function checkIfValidFile(fileName) {
